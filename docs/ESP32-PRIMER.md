...
5. **Tools → Port** — pick the one that appears when you plug the board in
6. Open `petdoor/petdoor.ino`, click **Upload**
...
arduino-cli upload  --fqbn esp32:esp32:esp32 -p /dev/cu.usbserial-0001 petdoor
```
